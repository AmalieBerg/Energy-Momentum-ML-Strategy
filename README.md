...
- **Comprehensive feature engineering**: 147+ technical and market features total across the dataset — 28 asset-specific features per asset across 5 energy commodities, plus 6 shared external market features (VIX, yield curve, DXY)
...
### Feature Engineering (146 features total — 34 per asset model)

The dataset contains 28 asset-specific features per commodity (140 total across 5 assets) plus 6 shared external market features, for 146 features in total. Each individual asset model trains on 34 features: the 28 specific to that asset plus the 6 shared market features.

**Momentum Features:**
- Multi-period momentum (5d, 10d, 21d, 60d, 126d, 252d)
